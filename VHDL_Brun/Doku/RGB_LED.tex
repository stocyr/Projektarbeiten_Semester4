...
Bei der Evaluation der LED war die Leistung unser Hauptkriterium. Wir haben uns schlussendlich für das Modell LZC-00MC40 von LedEngin Inc entschieden. Das Datenblatt ist im Anhang zu finden.

Die LED hat eine Gesamtleistung von 40W und je vier LEDs für jede der drei Farben rot, grün und blau. Die Vorwärtsspannungen variieren je nach Durchflussstrom aber die ungefähren Werte sind: $V_{F rot} \approx 9V$, $V_{F rot} \approx 9V$, $V_{F rot} \approx 9V$, 

\subsubsection{Stromquelle}
Als Stromquelle haben wir uns für eine Konstantstromquelle von ON Semiconductor entschieden - den CAT4101. Er hat 
